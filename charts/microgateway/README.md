  ...
  - [Security](#security)
    - [Store sensitive information in secrets](#store-sensitive-information-in-secrets)
      - [Secure handling of license and passphrase](#secure-handling-of-license-and-passphrase)
        - [Creating and referencing external secrets](#creating-and-referencing-external-secrets)
        - [Creating secrets with the Helm Chart](#creating-secrets-with-the-helm-chart)
      ...
      - [JWKS Service Secrets](#jwks-service-secrets)
        - [Configure a local JWKS Service with a secret](#configure-a-local-jwks-service-with-a-secret)
        - [Configure local JWKS services using extra volume mounts](#configure-local-jwks-services-using-extra-volume-mounts)
        - [Configure TLS for Remote JWKS Service with secrets](#configure-tls-for-remote-jwks-service-with-secrets)
        - [Configure TLS for Remote JWKS Service using extra volume mounts](#configure-tls-for-remote-jwks-service-using-extra-volume-mounts)
